...
namespace Cerebro
{
	public class YoutubeHelper : MonoBehaviour
	{


		public static VideoInfo RequestVideo(string urlOrId)
		{
			...
			video = videoInfos.OrderByDescending(x=>x.Resolution).First(info => info.VideoType == VideoType.Mp4  && info.Resolution<=720 );
