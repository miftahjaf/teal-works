...
namespace MaterialUI
{
    ...
    public class SnackbarAnimator : ToastAnimator
    {
        ...
        private IEnumerator Setup()
        {
            ...
            float buttonWidth = m_ActionButton.GetComponent<RectTransform>().GetProperSize().x;
            ...
            if (Screen.height > Screen.width)
            {
                ...
                m_Text.GetComponent<LayoutElement>().minWidth = Screen.width - (m_ActionButton.GetComponent<MaterialButton>().preferredWidth + 40f);
