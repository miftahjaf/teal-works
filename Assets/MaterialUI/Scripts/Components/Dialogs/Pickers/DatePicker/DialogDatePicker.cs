...
namespace MaterialUI
{
    ...
    public class DialogDatePicker : MaterialDialog
    {
        ...
        public void OnYearClicked()
        {
            ...
            TweenManager.AutoTween(m_CalendarCanvasGroup.gameObject, m_CalendarCanvasGroup, "alpha", 0.0f, 0.5f);
            TweenManager.AutoTween(m_YearCanvasGroup.gameObject, m_YearCanvasGroup, "alpha", 1.0f, 0.5f, 0.01f); // HACK: 0.01f of delay, because if not, the animation is not played
        ...
        {
            TweenManager.AutoTween(m_CalendarCanvasGroup.gameObject, m_CalendarCanvasGroup, "alpha", 1.0f, 0.5f);
            TweenManager.AutoTween(m_YearCanvasGroup.gameObject, m_YearCanvasGroup, "alpha", 0.0f, 0.5f, callback: () =>
            {
