...
namespace MaterialUI
{
    ...
    public class DialogTimePicker : MaterialDialog
    {
        ...
        private Action<int, int, bool> m_OnAffirmativeClicked;
        public Action<int, int, bool> onAffirmativeClicked
        {
        ...
        public void Initialize(int hour, int minute, bool isAM, Action<int, int, bool> onAffirmativeClicked, Color accentColor)
        {
        ...
        public void OnButtonOkClicked()
        {
            ...
            {
                m_OnAffirmativeClicked(m_CurrentHour, m_CurrentMinute, m_IsAM);
            }
