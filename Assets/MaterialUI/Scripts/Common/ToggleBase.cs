...
namespace MaterialUI
{
    public class ToggleBase : UIBehaviour
    {
		...
		[SerializeField]
		protected bool m_LastToggleInteractableState;
        ...
        protected override void Start()
        {
            ...
            {
                m_LastToggleInteractableState = m_Toggle.interactable;

                if (m_LastToggleInteractableState)
                {
        ...
        void Update()
        {
            ...
            if (m_LastToggleInteractableState != m_Toggle.interactable)
            {
                m_LastToggleInteractableState = m_Toggle.interactable;
        ...
        public virtual void AnimOn()
        {
            ...
            {
                m_Graphic.color = Tween.QuintSoftOut(m_CurrentGraphicColor, toggle.interactable ? m_GraphicOnColor : m_GraphicDisabledColor, m_AnimDeltaTime, animationDuration);
            }
        ...
        public virtual void AnimOff()
        {
            ...
            {
                m_Graphic.color = Tween.QuintSoftOut(m_CurrentGraphicColor, toggle.interactable ? m_GraphicOffColor : m_GraphicDisabledColor, m_AnimDeltaTime, animationDuration * 0.75f);
            }
            if (m_ChangeRippleColor && m_MaterialRipple != null)
            {
        ...
        private void SetOnColor()
        {
            if (m_Graphic && m_ChangeGraphicColor)
            {
                m_Graphic.color = toggle.interactable ? m_GraphicOnColor : m_GraphicDisabledColor;
            }
        ...
        private void SetOffColor()
        {
            if (m_Graphic && m_ChangeGraphicColor)
            {
                m_Graphic.color = toggle.interactable ? m_GraphicOffColor : m_GraphicDisabledColor;
            }
            if (materialRipple && m_ChangeRippleColor)
            {
                materialRipple.rippleData.Color = m_RippleOffColor;
