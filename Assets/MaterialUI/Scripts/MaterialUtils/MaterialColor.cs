...
namespace MaterialUI
{
    public class MaterialColor : MonoBehaviour
    {
        ...
        public static Color GetHighlightColor(Color baseColor, Color baseHighlightColor)
        {
            Color highlightColor = baseHighlightColor;

            if (baseColor.a > 0f)
            {
                HSBColor highlightColorHSB = HSBColor.FromColor(highlightColor);
                HSBColor normalColorHSB = HSBColor.FromColor(baseColor);
                ...
                {
                    highlightColor.r = Tween.Linear(baseColor.r, highlightColor.r, 0.2f, 1f);
                    highlightColor.g = Tween.Linear(baseColor.g, highlightColor.g, 0.2f, 1f);
                    highlightColor.b = Tween.Linear(baseColor.b, highlightColor.b, 0.2f, 1f);
                    highlightColor.a = Tween.Linear(baseColor.a, highlightColor.a, 0.2f, 1f);
                }

                if (highlightColor.a < 0.1f)
                {
