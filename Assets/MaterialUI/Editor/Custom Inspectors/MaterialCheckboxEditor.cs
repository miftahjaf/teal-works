...
namespace MaterialUI
{
	...
	class MaterialCheckboxEditor : MaterialBaseEditor
    {
        private MaterialCheckbox m_MaterialCheckbox;
        ...
        {
            m_MaterialCheckbox = (MaterialCheckbox)target;
		...
		private void ColorsSection()
		{
			...
			if (m_MaterialCheckbox.GetComponent<MaterialRipple>())
			{
