...
namespace MaterialUI
{
    ...
    public static class MaterialUIEditorTools
    {
        ...
        public static void CreateInstance(string assetPath, string objectName, params InstantiationOptions[] instantiationOptions)
        {
            ...
            {
                m_LastInstance.GetComponent<InstantiationHelper>().HelpInstantiate(instantiationOptions);
            }
        ...
        [MenuItem("GameObject/MaterialUI/Panel", false, 000)]
        private static void CreatePanel()
        {
            CreateInstance("Components/Panel", "Panel");
        }
        ...
        [MenuItem("GameObject/MaterialUI/Progress Indicators/Circle - Flat", false, 082)]
        ...
        [MenuItem("GameObject/MaterialUI/Progress Indicators/Circle - Raised", false, 082)]
        ...
        [MenuItem("GameObject/MaterialUI/Dividers/Light", false, 120)]
        private static void CreateDividerLight()
        {
            CreateInstance("Components/Divider", "Divider - Light");
            m_LastInstance.GetComponent<RectTransform>().anchoredPosition = Vector2.zero;
            m_LastInstance.GetComponent<Image>().color = new Color(1.0f, 1.0f, 1.0f, m_LastInstance.GetComponent<Image>().color.a);
        }

        [MenuItem("GameObject/MaterialUI/Dividers/Dark", false, 120)]
        private static void CreateDividerDark()
        {
            CreateInstance("Components/Divider", "Divider - Dark");
            m_LastInstance.GetComponent<RectTransform>().anchoredPosition = Vector2.zero;
        }
