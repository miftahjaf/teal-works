...
{
	[ExecuteInEditMode]
	[AddComponentMenu("MaterialUI/Progress/Cerebro Circular Progress Indicator")]
	public class ProgressHelper : ProgressIndicator
	{
		...
		public override void Show()
		{
			...
			m_AnimSizeCurrentSize = rectTransform.localScale.x;
