...
//						Answer = num6.ToString() + "/" + lcm.ToString ();
				...
				//doubt
					...
					num2 = Random.Range (num1, 20);
					QuestionText.text = "A burger was marked at Rs." + num.ToString () + ", but sold at " + num1.ToString () + "/" + num2.ToString () + " of its marked price. Find the sale price.";
					num3 = num * num1;
					...
					num1 = (num + 3)*2;
					num2 = Random.Range (3, 11) *2;
					num3 = Random.Range (3, 11)*2;
					num4 = Random.Range (1, 10);
					num4 = num4 * 50 * Random.Range(20,51);
					...
					num6 = lcm - num5;
					ans = (num4 * num6);
					int hcf = MathFunctions.GetHCF (ans, lcm);
					ans = ans / hcf;
					lcm = lcm / hcf;
					if (lcm == 1)
						Answer = ans.ToString ();
					else
					Answer = ans.ToString()+"/"+ lcm.ToString();
				...
				if (selector == 1) {
					...
					QuestionText.text="Eden practices football for "+num.ToString()+"/"+num1.ToString()+" hours on friday, "+num2.ToString()+"/"+num3.ToString()+" hours on saturday and " + num4.ToString()+"/"+ num5.ToString() +" hours on sunday. He practices "+num6.ToString()+" hours in total during the week." +
						"Find the ratio of the practice done on the rest 4 days to the weekly practice.";  
					...
					num1 = Random.Range (1, 6) + num;
					num2=Random.Range(2,11);
					num2=num2*5000;
					QuestionText.text="Bill wants to distribute his savings amongst Tanya, Mike and Rishabh. "+num.ToString()+"/"+num1.ToString()+" of his savings is in the name of Tanya. Rest is equally divided among Mike and Rishabh. If Rishabh receives Rs."+num2.ToString()+", calculate Bill's total savings.";
					...
					num4 = num3 + Random.Range (1, 4);
					num = num3 + Random.Range (3, 7);
					num1=num+Random.Range(1,4);
					...
					num2=num2*10;
					QuestionText.text="A can of milk is "+num.ToString()+"/"+num1.ToString()+"th full. When "+num2.ToString()+" litres of milk was sold, the can was still "+num3.ToString()+"/"+num4.ToString()+"th full. Find the capacity of the can (in litres).";
					lcm = MathFunctions.GetLCM (num1, num4);
					num1 = lcm / num1;
					num4 = lcm / num4;
					num5 = (num * num1) - (num3 * num4);
					...
					num4=num4*100;
					QuestionText.text="Nikki and Neha together have "+num.ToString()+"/"+num1.ToString()+" of what Kashish has. Nikki's money is 1/" +num3.ToString()+" of Neha's. If Kashish has Rs."+num4.ToString()+", how much is Neha's money?";
					num2 = 1 + num3;
					num5 = (num * num4 * num3);
					num6 = (num1 * num2);
