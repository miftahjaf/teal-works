			...
			if (level == 2)
			{
				...
				if (selector == 1) // using angle properties
				{
					...
					else 
					{
						...
						if (randSelector1 == 1)
						{
							diagramHelper.AddLinePoint (new LinePoint ("", new Vector2 (breadthForDiagram, breadthForDiagram), 270 - angle1, true, breadthForDiagram / Mathf.Cos (angle1 * Mathf.Deg2Rad)).FlipArrow());
						...
						{
							diagramHelper.AddLinePoint (new LinePoint ("", new Vector2 (breadthForDiagram, 0), 90 + angle1, true, breadthForDiagram / Mathf.Cos (angle1 * Mathf.Deg2Rad)).FlipArrow());
