...
{
	private Cerebro.Unit _unit;
    private List<Cell> _pathsInRange;
	private List<Cerebro.Unit> _unitsInRange;

    private Cell _unitCell;

	public CellGridStateUnitSelected(Cerebro.CellGrid cellGrid, Cerebro.Unit unit) : base(cellGrid)
    {
        _unit = unit;
        _pathsInRange = new List<Cell>();
		_unitsInRange = new List<Cerebro.Unit>();
    }
