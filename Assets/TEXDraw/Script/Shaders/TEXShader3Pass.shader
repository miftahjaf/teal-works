...
Shader "TEXDraw/Default/3 Pass"
{
	...
	SubShader
	{
		...
		UsePass "TEXDraw/Default/4 Pass/SECONDPASS"
		UsePass "TEXDraw/Default/4 Pass/THIRDPASS"
		UsePass "TEXDraw/Default/4 Pass/PRIMARYPASS"
	}
}