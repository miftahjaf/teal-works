...
Shader "TEXDraw/Lit Transparent/4 Pass"
{
	Properties
	{
		[Header(Using 32 Textures and 4x2 Batches per Component)]
	...
	SubShader
	{
		...
		#pragma surface surf PPL alpha novertexlights noshadow nolightmap nofog
		
		void surf (Input IN, inout SurfaceOutput o)
		{			
			fixed4 col2 = getTexPoint(IN.uv_Font0, determineIndex(IN.uv2_Font1));
